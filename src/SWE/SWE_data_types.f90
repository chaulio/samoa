...
#		if defined(_SWE_PATCH)
			type(t_state), DIMENSION(0)			:: Q !TODO: remove this and others Qs --> must handle conflicts with t_gv_Q methods afterwards...
...
#		endif
		...
		type num_cell_update
            ...
            type(t_update), DIMENSION(0)                                                :: flux                     !< cell update
#else
